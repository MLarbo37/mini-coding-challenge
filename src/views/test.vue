<template>
    <div class="px-0 sm:px-4 h-[83vh] w-full">
      ...
      >
        ...
        <form>
          ...
          <div v-if="input.share_option === 'Share with qroup'" class="mb-6 px-4">
            <SelectField
              type="text"
              data-cy="company-folder"
              id="manager"
              v-model="input.employee_type"
              :requireTag="true"
          ...
          <div class="mb-6 px-4" v-if="input.share_option === 'Share with qroup'">
            <SelectField
              type="text"
              data-cy="company-folder"
              id="Position"
          ...
          <div v-if="input.share_option === 'Share with all employees'" class="mb-6 px-4">
            <SelectField
              label="Select individuals"
              type="text"
              data-cy="company-folder"
              id="Select_individuals"
              v-model="input.specific_individuals"
              :requireTag="true"
              placeholder="Position"
              :options="[
                'Share with specific individual',
  ...
  import { GET_COMPANY_DOCUMENT } from "../../../graphql/queries/queries.ts";
  ...
  console.log(props.data.folders_files , 'props.data.folders_files')
